...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-muted small mb-0">Consulte, filtre e gerencie os itens disponíveis no estoque.</p>
    </div>
            ...
            <div class="col-md-5">
                <div class="input-group">
                    ...
                    <input type="text" name="search" class="form-control border-start-0"
                           placeholder="Buscar por nome do produto..." value="{{ request('search') }}">
                </div>
            </div>
                                ...
                                <div class="btn-group btn-group-sm">
                                    ...
                                    <form action="{{ route('products.destroy', $product->id) }}"
                                        ...
                                        <button type="submit"
                                                ...
                                                title="Excluir"
                                                onclick="return confirm('Tem certeza que deseja remover este produto do catálogo?')">
